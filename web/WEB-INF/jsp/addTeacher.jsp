        ...
        <div class="col-md-11" style="height: 100%">
            <div class="row clearfix">
                <div class="page-header">
                    <h2 class="text-center"  style="color: #337ab7">添加教师</h2>
                </div>
            </div>
            <form action="${pageContext.request.contextPath}/teacher/addTeacher" method="post">
                    ...
                    <div class="form-group">
                        <label>性别：</label>
                        <input type="text" name="teacherGender" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>年龄：</label>
                    ...
                    <div class="form-group">
                        <label>办公室：</label>
                        <input type="text" name="teacherRoom" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>教师职称：</label>
                        <input type="text" name="teacherTitle" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>联系方式：</label>
                    ...
                    <div class="form-group">
                        <label>家庭住址：</label>
                        <input type="text" name="teacherAddress" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>民族：</label>
                        <input type="text" name="teacherNation" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>政治面貌：</label>
                        <input type="text" name="teacherStatus" class="form-control" required>
                    </div>
                    <div class="checkbox">
                        <label>
